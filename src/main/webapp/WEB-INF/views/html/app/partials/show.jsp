...
<dl class="dl-horizontal">
	...
	<span ng-show="getIdByContext('zenon-thesaurus') || getIdByContext('arachne-place-id')">
		...
		<dd ng-show="getIdByContext('arachne-place-id')">
			<a href="http://arachne.uni-koeln.de/arachne/index.php?view[layout]=search_result_overview&view[category]=overview&search[constraints]=FS_OrtID:%22{{getIdByContext('arachne-place-id').value}}%22" target="_blank">
