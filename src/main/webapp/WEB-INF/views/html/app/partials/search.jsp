	...
	<ul class="nav nav-pills" style="display:inline-block; margin-bottom: 0;">
		...
		<li class="dropdown pull-right">
			...
			<ul class="dropdown-menu">
				<li><a ng-href="../search.kml?q={{search.q}}&limit=3000&type={{search.type}}" target="_blank">KML</a></li>
				<li><a ng-href="../search.json?q={{search.q}}&limit=3000&type={{search.type}}" target="_blank">JSON</a></li>
			</ul>
		</li>
	</ul>
