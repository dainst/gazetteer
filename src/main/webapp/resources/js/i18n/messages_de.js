...
messages.factory('messages', function(){
	return {
		...
		"ui.place.user-group-info": "Wenn eine Benutzergruppe festgelegt wird, ist der Ort nur für Mitglieder dieser Gruppe sichtbar. Diese Einstellung kann zu einem späteren Zeitpunkt nicht mehr geändert werden.",
