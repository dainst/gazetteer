...
public class ShapefileCreator {
	...
	public void createReadmeFile(File folder, String query) throws Exception {
		...
		try {
			...
			writer.println("IDAI.WELT GAZETTEER DATA -- README v1.0 07/02/2017");
			writer.println("");
			...
			writer.println("");
			writer.println(" pnameanc	boolean	Is the preferred name ancient or not.");
			writer.println("");
			writer.println(" pnametrnsl	boolean	Is the preferred name transliterated or not.");
			writer.println("");
			...
			writer.println(" ");
			writer.println(" loctype	string	Whether a given localisation is the preferred one or not:");
			...
			writer.println("");
			writer.println(" parent	 	integer	The unique Gazetteer key of a place that is the parent of ");
			writer.println("						(i.e. contains) the current place.");
			writer.println("");
			writer.println(" relatedN	string	(With N=1...10): Gazetteer keys of somehow related places.");
			writer.println("");
			writer.println(" tagN		string	(With N=1..5): Associated Gazetteer tags.");
			writer.println("");
			writer.println(" provN		string	(With N=1..5): Provenance (source) information.");
			writer.println("");
			writer.println(" idNcontxt	string 	(With N=1..10): The Context of an associated ID.");
			writer.println("");
			writer.println(" idNvalue	string  (With N=1..10): Associated IDs from other projects/databases.");
			writer.println("");
			writer.println(" linkN		string  (With N=1..5): Associated links (URLs).");
			writer.println("");
			writer.println(" commentN	string  (With N=1..5): An explaining comment to the place (if necessary).");
			writer.println("");
			writer.println(" recgroup	string	Whether a place belongs to a certain recordgroup within the Gazetteer.");
			writer.println("");
