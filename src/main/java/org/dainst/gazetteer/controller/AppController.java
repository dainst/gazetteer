...
public class AppController {
    ...
    public String app(
        ...
        model.addAttribute(
            "languages",
            langHelper.getLocalizedLanguages(locale)
        );
    ...
    public String appPartials(
        ...
        if (principal != null && principal instanceof User) {
            ...
            for (GroupRole groupRole : groupRoles) {
                RecordGroup group = recordGroupDao
                    .findById(groupRole.getGroupId())
                    .orElse(null);
                if (
                    groupRole.getRoleType().equals("admin") ||
                    groupRole.getRoleType().equals("edit") ||
                    groupRole.getRoleType().equals("read")
