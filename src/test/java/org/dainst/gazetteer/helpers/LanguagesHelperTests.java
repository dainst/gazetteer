...
public class LanguagesHelperTests {
    ...
    public void testLocaleForISO3Language() {
        ...
        assertEquals(
            "en",
            helper.getLocaleForISO3Language("eng").getLanguage()
        );
        assertEquals(
            "de",
            helper.getLocaleForISO3Language("deu").getLanguage()
        );
        assertEquals(
            "it",
            helper.getLocaleForISO3Language("ita").getLanguage()
        );
        assertEquals(
            "fr",
            helper.getLocaleForISO3Language("fra").getLanguage()
        );
        assertEquals(
            "el",
            helper.getLocaleForISO3Language("ell").getLanguage()
        );
        assertEquals(
            "la",
            helper.getLocaleForISO3Language("lat").getLanguage()
        );
        assertEquals(
            "grc",
            helper.getLocaleForISO3Language("grc").getLanguage()
        );
        assertEquals(
            "sq",
            helper.getLocaleForISO3Language("sqi").getLanguage()
        );
        assertEquals(
            "pl",
            helper.getLocaleForISO3Language("pol").getLanguage()
        );
        assertEquals(
            "tr",
            helper.getLocaleForISO3Language("tur").getLanguage()
        );
        assertEquals(
            "ar",
            helper.getLocaleForISO3Language("ara").getLanguage()
        );
        assertEquals(
            "es",
            helper.getLocaleForISO3Language("spa").getLanguage()
        );
        assertEquals(
            "pt",
            helper.getLocaleForISO3Language("por").getLanguage()
        );
        assertEquals(
            "zh",
            helper.getLocaleForISO3Language("zho").getLanguage()
        );
        assertEquals(
            "ru",
            helper.getLocaleForISO3Language("rus").getLanguage()
        );
        assertEquals(
            "vi",
            helper.getLocaleForISO3Language("vie").getLanguage()
        );
    }
    ...
    public void testDisplayNamesGerman() {
        ...
        Map<String, String> localizedLanguages = helper.getLocalizedLanguages(
            Locale.GERMAN
        );
        ...
        assertEquals("Latein", localizedLanguages.get("lat"));
